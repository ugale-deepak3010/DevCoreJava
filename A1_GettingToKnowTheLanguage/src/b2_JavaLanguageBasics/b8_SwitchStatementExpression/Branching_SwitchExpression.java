...
public class Branching_SwitchExpression {
	...
	public static void main(String[] args) {
		...
		// Switch Expression -> support yield
		// Switch statement NOT support yield/return
		...
		Day day = Day.SATURDAY; // any day Normal switch case but used Enum
		...
		// MODIFIED | This why branching required!
	...
	String quarterLabel = switch (quarter) {
	case 0:
		yield "Q1 - Winter"; // just yield use for return
	case 1:
		yield "Q2 - Spring";
	case 2:
		yield "Q3 - Summer";
